...
// Trakt sits behind Cloudflare bot protection that 403s requests with no
// User-Agent — Node's fetch sends none by default (curl works, the app
// didn't). Verified live: identical request 403 without UA, 200 with.
const USER_AGENT = 'natter.cc/1.0 (+https://natter.cc)';
